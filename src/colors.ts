...
export function ui(theme: Theme): IUi {
    ...
    return {
        caret: themes({ light: scale.blue[7], dark: scale.blue[2], dimmed: scale.blue[2] }),
        gutter_foreground: color.codemirror.linenumberText,
        line_highlight: color.codemirror.activelineBg,
        find_highlight: themes({ light: scale.yellow[4], dark: "#ffd33d44", dimmed: "#ffd33d44" }),
        highlight:  themes({ light: "#34d058", dark: "#17E5E6", dimmed: "#17E5E6" }),
...
export function colors(theme: Theme): IColors {
    ...
    return {
        ...
        comments: themes({ light: scale.gray[5], dark: scale.gray[3], dimmed: scale.gray[3] }),
...
export function rules(theme: Theme): IRules[] {
    ...
    return [
        ...
        {
            scope: ['meta.property-name', 'meta.mapping.key string.quoted.double'],
            settings: {
                foreground: themes({
                    light: scale.blue[6],
                    dark: scale.blue[2],
